...
\section{课后习题
I：内容详细对照（与原文逐项比对）}\label{ux7b51ux57faux7bc7ux8bfeux540eux4e60ux9898-iux5185ux5bb9ux8be6ux7ec6ux5bf9ux7167ux4e0eux7b51ux57faux7bc7ux539fux6587ux9010ux9879ux6bd4ux5bf9}
...
\textbf{一句话对照}：习题没有发明新结构------四个新定理都是已有定理的\textbf{双向化}（单向→双向）与\textbf{组合化}（分离→对偶/全景）。这正是''用结构找回精确''在形式化层面的体现：锚定结构不变，论证收束。
...
2.1（验证）------三根支柱在 P vs NP 上的合取。R153
...
章节）}\label{ux56dbux8bbaux8bc1ux94feux5bf9ux7167ux4e60ux9898ux7ae0ux8282-ux7b51ux57faux7bc7ux7ae0ux8282}
...
\bottomrule\noalign{}
\endlastfoot
零、总论 & 发散/收敛互锁对投影 & ·十二（R147
因果与时间，causality\_pair\_reduces）；·十三（R148 互锁同构） \\
一、①表=结构 & 有限域函数=预计算表 &
·RulerLookup（function\_is\_table）；R057 一切皆表 \\
一、②验证不重算 & 查表判等 & ·R152 ②（verification\_free） \\
二、①单向已有 & R153 np\_witness\_in\_table & ·十八（R153 ④） \\
二、②反向封死 & lookup\_correct 表值=函数值 &
·RulerLookup（lookup\_correct） \\
三、①模糊换速度 & N 存在性由相位锁定外推 & ·十七·十八（R150
王氏定理 / R153 ③） \\
三、②结构找回精确 & 表判等还原真值 &
·RulerLookup/RulerRevLookup \\
三、③互锁对 & 发散端存在性/收敛端精确性 & ·十二（R147）；R047
发散/收敛同一对称性 \\
四、①N=外推 & pat\_phase\_unification & ·十六（R150
王氏相位锁定性定理） \\
四、②验证=判等 & lookup\_iff\_value & ·十七（R152）+
RulerLookup \\
四、③P=锁定链 & deterministic\_locked\_chain\_unique & ·十八（R153
①）；R050 机制；R136 方向声明 \\
四、④有限域平凡 & 表全量 ⟹ 模糊不必要 & ·十七（R152 ①
finite\_domain\_P\_eq\_NP） \\
四、⑤诚实边界 & 非 P≠NP 判定 & ·十七（R152 诚实边界原句延续） \\
\end{longtable}
}

\textbf{结论}：习题全部论证步骤都能在找到章节级落点，无悬空引用；新增内容只发生在''双向化/组合化''层面。
...
\emph{课后习题 I 对照文档 · 2026-08-13 · 无新增
