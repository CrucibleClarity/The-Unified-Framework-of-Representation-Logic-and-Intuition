...
the author has published the 0pat framework in prior work \cite{zenodo}, where natural numbers emerge as polyphase counts
...
files and the hash ledger (\texttt{iso\_hashes.md}) are archived in the author\'s prior records (details available on request).
...
verification log are archived in the author\'s prior records (details available on request). The complete submission package
...
\bibitem{zenodo}
Author, \emph{0pat Exercise XXXVII: The Riemann Direction, Unified},
2026. DOI:

(version 1);  (version 2).
\bibitem{patbase}
Author, \emph{Empirical Foundations of Pat: Transformer OOD Observations,
...
been published in the author's prior work (\S\ref{sec:methodology}).
