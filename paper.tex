...
(基点构造诱导下的数学空间穿折越证明方法): ``数学空间的穿越、折越'' (crossing, folding,
...
\acks{The author thanks DeepSeek for the Lean formalization and for its insistence on
the honest boundary that the Riemann hypothesis remains unproved.}
